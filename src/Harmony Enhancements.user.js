    ...
    */
    ...
    function handleSeederFormSubmit(event) {
        ...
        if (formName === 'release-update-seeder' && AppState.settings[SETTINGS_CONFIG.fullUpdateSeeding.key]) {
            ...
            if (AppState.dom.seederForm) {
                AppState.dom.seederForm.querySelectorAll('input[type="hidden"][name^="urls."]').forEach(input => {
                    rawParameters.set(input.name, input.value);
                });
            }
    ...
    function cacheReleaseLookupPageDOM() {
        ...
        AppState.dom.seederForm = document.querySelector('form[name="release-seeder"]');
        AppState.dom.updateSeederForm = document.querySelector('form[name="release-update-seeder"]');
        AppState.dom.updateSeederNoteInput = AppState.dom.updateSeederForm?.querySelector('input[name="edit_note"]');
